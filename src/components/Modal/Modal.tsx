        ...
        <div className="modal__wrapper" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="modal__body">
            <div className="modal__content content">
              ...
              <form className="content__header" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="content__body">
                ...
                {searchWeather.data?.map((item: any): React.ReactElement => {
                  return <SearchWeatherCard setModalStatus={setModalStatus} key={item.id}
                                            data={item}></SearchWeatherCard>;
                })}
              </div>
